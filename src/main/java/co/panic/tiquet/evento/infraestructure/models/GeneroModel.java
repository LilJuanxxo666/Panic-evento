...
public class GeneroModel {
    ...
    public GeneroModel(UUID id, String nombre, String descripcion) {
        setId(id);
        setNombre(nombre);
        setDescripcion(descripcion);
    }

    public static GeneroModel create() {
    ...
    public GeneroModel setId(UUID id) {
    ...
    public GeneroModel setNombre(String nombre) {
    ...
    public GeneroModel setDescripcion(String descripcion) {
